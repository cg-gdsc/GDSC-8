...
class TestSendResults:
    ...
    def test_make_submission_dry_run(self, mock_session, mock_request, capsys):
        ...
        response = make_submission(valid_results, dry_run=True)
    ...
    @patch('src.utils.requests.request')
    @patch('src.utils.boto3.Session')
    def test_make_submission_success(self, mock_session, mock_request, capsys):
        ...
        response = make_submission(valid_results)
    ...
    @patch('src.utils.requests.request')
    @patch('src.utils.boto3.Session')
    def test_make_submission_failure(self, mock_session, mock_request, capsys):
    ...
    @patch('src.utils.boto3.Session')
    def test_make_submission_no_credentials(self, mock_session):
        ...
        with pytest.raises(ValueError, match="AWS credentials not found"):
            make_submission(valid_results)

    def test_make_submission_invalid_format(self):
        ...
        with pytest.raises(ValueError, match="missing required fields"):
            make_submission(invalid_results)
